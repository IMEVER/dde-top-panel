...
DiskControlItem::DiskControlItem(const DiskInfo &info, QWidget *parent)
    : QFrame(parent),
      ...
      m_diskIcon(new QLabel(this)),
      m_diskName(new QLabel(this)),
      m_diskCapacity(new QLabel(this)),
      m_capacityValueBar(new QProgressBar(this)),
...
//    QIcon::setThemeName("deepin");
    ...
    connect(m_unmountButton, &DIconButton::clicked, [this] {emit requestUnmount(m_info.m_id);});
